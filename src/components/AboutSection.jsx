...
export const AboutSection = () => {
    return (
        <section className='wrapper-transparent mt-[20px] about-section p-4 flex gap-9 text-white' >
            ...
            <div className='flex flex-col flex-1'>
                ...
                <ul className='principles-list'>
                    <li className='principles-list-item'>Empatía: Conectarnos con nuestros pacientes, familias, médico y colaboradores es lo más importante para un relacionamiento coordinado y armónico</li>
